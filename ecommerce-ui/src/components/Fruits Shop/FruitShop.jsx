          ...
          content: [
            {
              ...
              price: '$4.99 / kg',
              weight: '2 kg',
              description: 'Fresh and sweet red grapes, perfect for snacking or adding to fruit salads.',
            ...
            },
            {
              ...
              price: '$5.99 / kg',
              weight: '1.5 kg',
              description: 'Deliciously sweet and tart raspberries, great for desserts or smoothies.',
            ...
            },
            {
              ...
              price: '$2.49 / kg',
              weight: '1.8 kg',
              description: 'Fresh organic carrots, packed with vitamins and perfect for soups or salads.',
            ...
            },
            {
              ...
              price: '$1.99 / kg',
              weight: '1 kg',
              description: 'Ripe bananas, a perfect on-the-go snack or addition to your morning smoothie.',
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              price: '$2.99 / kg',
              weight: '1.5 kg',
              description: 'Crisp, organic cucumbers perfect for salads or refreshing snacks.',
              image: 'src/images/fruite-item-3.jpg'  // Replace with actual image path
            }
          ]
        },
          ...
          content: [
            {
              ...
              price: '$3.49 / kg',
              weight: '1.2 kg',
              description: 'Juicy, sweet mangoes, ideal for smoothies, salsas, or enjoying fresh.',
              image: 'src/images/fruite-item-5.jpg'  // Replace with actual image path
            },
            {
              id: 2,
              ...
              price: '$2.99 / kg',
              weight: '1.5 kg',
              description: 'Sweet and tangy pineapples, perfect for fresh fruit salads or tropical juices.',
                                        ...
                                        <div key={product.id} className="product-box bg-white rounded-lg relative hover:shadow-custom-shadow transition-shadow duration-300 border border-default-gold">
                                            ...
                                            <div className="products-description text-center p-5 rounded-bl-xl rounded-br-xl">
                                                ...
                                                <div className="price-add-cart text-left flex gap-3 justify-between items-center">
                                                    ...
                                                    <a href="#" className='rounded-full border border-default-gold px-3 py-2'>
                                                        <FontAwesomeIcon icon={faLock} color='#81c408' />
                                                        <span className='pl-3 font-semibold text-default-green'>Add to cart</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
